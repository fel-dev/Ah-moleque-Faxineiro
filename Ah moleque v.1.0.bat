...
echo.
CertUtil -hashfile "Ah moleque v.1.0.bat"
CertUtil -hashfile "Ah moleque v.1.0.bat">"hash_Ah moleque v.1.0.txt"
echo Hash do programa salvo com sucesso automaticamente em "../hash_Ah moleque v.1.0.txt"
echo.
...
@echo    ***                                               ***
@echo    ***   NAO PRECISA DE PROGRAMA PRA LIMPAR O PC     ***
@echo    ***                                               ***
@echo    ***            NOS SOMOS O PROGRAMA               ***
@ECHO    ***               AH, MOLEQUE!!!!                 ***
@echo    ***                                               ***
@echo    ***                                               ***
@echo    ***          BY CorreaFlp Informatica             ***
@echo    *****************************************************

msg * Memoria limpa. 
msg * AH! MOLEQUE!!
msg * TAMO JUNTO LIMPEZA DE ARQUIVOS TEMPORARIOS FINALIZADA!
msg *   NAO PRECISA DE PROGRAMA PRA LIMPAR O PC      NOS SOMOS O PROGRAMA                AH, MOLEQUE!!!!                  BY FELIPE CORREA CARNEIRO  *
